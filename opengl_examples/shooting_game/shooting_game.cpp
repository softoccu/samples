...
const unsigned int SCR_WIDTH = 1600; // Double the width
const unsigned int SCR_HEIGHT = 1200; // Double the height
...
const float enemyWidth = 0.2f;
const float enemyHeight = 0.2f;
